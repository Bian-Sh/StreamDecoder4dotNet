...
QT_MOC_LITERAL(1, 8, 20), // "OnDemuxSuccessSignal"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "Session\0OnDemuxSuccessSignal\0"
};
...
void Session::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->OnDemuxSuccessSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Session::OnDemuxSuccessSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Session::OnDemuxSuccessSignal()
{
