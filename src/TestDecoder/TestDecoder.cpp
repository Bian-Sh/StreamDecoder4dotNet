...
TestDecoder* TestDecoder::self = NULL;

void TestDecoder::OnFrame(Frame* frame)
{
#ifdef USE_WIDGET
...
void TestDecoder::OnSessionEvent(int playerID, int eventType)
{
	//BeginDecode(session);
}
...
void OnDraw_cb(Frame* frame) { TestDecoder::self->OnFrame(frame); }

void OnEvent_cb(int playerID, int eventType) { TestDecoder::self->OnSessionEvent(playerID, eventType); }
...
void TestDecoder::on_CreateSession_clicked()
{
	/*if (session) return;
...
void TestDecoder::on_DeleteSession_clicked()
{
...
void TestDecoder::on_TryBitStreamDemux_clicked()
{
	/*if (!session) return;
...
void TestDecoder::on_TryNetStreamDemux_clicked()
{
	//if (!session) return;
...
void TestDecoder::on_BeginDecode_clicked()
{
	/*if (!session) return;
	BeginDecode(session);*/
}

void TestDecoder::on_StopDecode_clicked()
{
	/*if (!session) return;
	StopDecode(session);*/
...
void TestDecoder::on_GetFree_clicked()
{
	/*if (!session) return;
	qDebug() << GetCacheFreeSize(session);*/
}

void TestDecoder::on_OpenFile_clicked()
{
...
void TestDecoder::on_StartSendData_clicked()
{
	
}

void TestDecoder::on_EndSendData_clicked()
{
	isExit = true;
}
